      ...
      <div className={` ${styles.paddingY} ${styles.flexStart}`}>
        <div className={`${styles.boxWidth}`}>
          <div className={`${styles.flexCenter} flex-col`}>
            <h1 className="text-[#D9D9D9] font-bold text-[52px] tracking-[8px]">About Us</h1>
            <p className="text-white/75 xs:ml-10">Welcome to A Business Studio. One Stop For All Your Business Needs</p>
          </div>
          <Ourfounder />
          <Team/>
          <section className={`${styles.flexStart} sm:mb-6 sm:mt-[80px] my-6 sm:px-16 px-1 sm:py-20 py-4  sm:flex-row flex-col bg-[#D9D9D9] rounded-[100px] box-shadow lg:mx-40 group`}>
            <div className="flex-1 flex flex-col text-black  ">
              ...
              <p className={`font-outfit font-semibold sm:text-[24px] text-[18px] leading-[30.8px] mt-5 text-center group-hover:scale-[1.03] ease-in-out duration-300 group-hover:text-[#2632A1] lg:mx-20 md:mx-20 mx-12 `}>
